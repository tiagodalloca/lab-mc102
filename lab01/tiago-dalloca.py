...
# A entrada do programa será composta da distância D, em estádios, e do ângulo A, em graus, respectivamente, um número em cada linha.

# SAÍDA

# A saída mostra a circunferência Ce, em estádios, e Ckm, em quilômetros, do planeta seguindo o cálculo feito por Eratóstenes para a Terra com uma casa decimal de precisão.
